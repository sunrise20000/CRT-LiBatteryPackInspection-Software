...
namespace SicSimulator.Instances
{
    public class SimulatorSystem : Singleton<SimulatorSystem>
    {
        ...
        {
            IO.DI["DI_LoadLifterCYDown"].Value = true;
            ...
            IO.AI["AI_TMPressure1"].FloatValue = 1020;
            IO.AI["AI_LoadPressure"].FloatValue = 1020;
        ...
        private void SetDefaultValue(string mod)
        {
            ...
            IO.DI[$"{mod}.DI_PM1DryPumpAlarm"].Value = true;
            IO.DI[$"{mod}.DI_PM1DryPump1Warning"].Value = true;
            IO.DI[$"{mod}.DI_PM1DryPump1Running"].Value = true;
            ...
            IO.DI[$"{mod}.DI_TMPump1FlowSW"].Value = true;
            IO.DI[$"{mod}.DI_TMPump2FlowSW"].Value = true;
            ...
            IO.DI[$"{mod}.DI_TMBufferFlowSW"].Value = true;
            IO.DI[$"{mod}.DI_TMTopLidFlowSW"].Value = true;
            ...
            //IO.DI[$"{mod}.DI_PowerRackExhaustDPSW"].Value = true;
            IO.DI[$"{mod}.DI_ServoDriverFaultSW"].Value = true;
            ...
            IO.DI[$"{mod}.DI_UPS1Enable"].Value = false;
            IO.DI[$"{mod}.DI_UPS2Enable"].Value = false;
