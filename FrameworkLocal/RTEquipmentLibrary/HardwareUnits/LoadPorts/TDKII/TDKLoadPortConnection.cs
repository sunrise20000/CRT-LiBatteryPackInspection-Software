...
{
    public class TDKLoadPortMessage : AsciiMessage
    {
        public string CommandType { get; set; }
        public string Command { get; set; }
        public string Data { get; set; }
    }
    public class TDKLoadPortConnection : SerialPortConnectionBase
    {
        
        private TDKIILoadPort _device;
        public TDKLoadPortConnection(TDKIILoadPort device, string portName, int baudRate = 9600, int dataBits = 8, Parity parity = Parity.None, StopBits stopBits = StopBits.One)
        ...
        {
            TDKLoadPortMessage msg = new TDKLoadPortMessage();
        ...
        {
            TDKLoadPortMessage message = msg as TDKLoadPortMessage;
    ...
    public class TDKLoadPortTCPConnection :TCPPortConnectionBase
    {
        private TDKIILoadPort _device;
        public TDKLoadPortTCPConnection(TDKIILoadPort device, string ipaddress)
            : base(ipaddress)
        {
            _device = device;
        }
