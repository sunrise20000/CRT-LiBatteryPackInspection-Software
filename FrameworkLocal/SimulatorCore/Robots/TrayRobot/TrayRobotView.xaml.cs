...
namespace MECF.Framework.Simulator.Core.Robots
{
    ...
    /// </summary>
    public partial class TrayRobotView : UserControl
    {
        public TrayRobotView()
        {
            InitializeComponent();
            this.DataContext = new TrayRobotViewModel();
    ...
    class TrayRobotViewModel : SocketDeviceViewModel
    {
        public string Title
        {
            get { return "Tray Robot Simulator"; }
        }

        private TrayRobotSimulator _robot;
        ...
        public TrayRobotViewModel() : base("TrayRobotViewModel")
        {
            _robot = new TrayRobotSimulator();
            Init(_robot);
