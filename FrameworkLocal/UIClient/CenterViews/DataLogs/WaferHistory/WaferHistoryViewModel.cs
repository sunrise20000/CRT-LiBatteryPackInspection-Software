...
namespace MECF.Framework.UI.Client.CenterViews.DataLogs.WaferHistory
{
    public class WaferHistoryDetail
    {
        ...
        public string NotchAngle { get; set; }
    }
    ...
    public class WaferHistoryViewModel : BaseModel
    {
        ...
        protected override void OnViewLoaded(object _view)
        {
            ...
            this.view = (WaferHistoryView)_view;
