...
{
    public class IoN2Dilution : BaseDevice, IDevice
    {
        ...
        public IoN2Dilution(string module, XmlElement node, string ioModule = "")
        {
        ...
        public bool Initialize()
        {
            ...
            DATA.Subscribe($"{Module}.N2FlowMode", () => FlowModeStr);
            return true;
        }
