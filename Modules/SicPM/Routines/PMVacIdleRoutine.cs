...
namespace SicPM.Routines
{
    public class PMVacIdleRoutine : PMBaseRoutine
    {
        ...
        public PMVacIdleRoutine(ModuleName module, PMModule pm) : base(module, pm)
        {
        ...
        public override Result Start(params object[] objs)
        {
            ...
            {
                EV.PostAlarmLog(Module, $"can not run VACIdle, {reason}");
                return Result.FAIL;
            }
        ...
        public override Result Monitor()
        {
            ...
            _pmIoInterLock.SetPMVacIdleRountingRunning(false, out string reason);
