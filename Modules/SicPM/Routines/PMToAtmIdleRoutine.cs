    ...
    public class PMToAtmIdleRoutine : PMBaseRoutine
    {
        ...
        public override Result Monitor()
        {
            try
            {
                ...
                WaitPmPressureUPto((int)RoutineStep.WaitPmPressureUp, _ventBasePressure, _waitPMPressureUpTimeout); 
            }
        ...
        {
            _pmIoInterLock.SetPMAtmIdleRountingRunning(false, out string reason);
