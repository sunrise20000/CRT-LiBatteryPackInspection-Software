...
{
    public abstract class FeederModuleBase : OfflineTimeoutNotifiableModuleBase, ITransferTarget, IModuleDevice
    {
        private int _slot = 1;

        public FeederModuleBase(int slot)
        {
            _slot = slot;
        }
        ...
        public abstract int InvokeFeed();
    }
}
